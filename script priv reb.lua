...
task.spawn(function()
    while true do
        ...
        if not SelectedQuest then
            game:GetService("ReplicatedStorage").Package.Events.p:FireServer("Blacknwhite27", 1, false)
            game:GetService("ReplicatedStorage").Package.Events.kb:FireServer(1, false, CFrame.new())
...
local questDataOutsideID = {
   {range = {0, 850000}, options = {"Kid Nohag", "Klirin"}},
    {range = {850001, 4500000}, options = {"Super Vegetable", "Chilly"}},
    {range = {4500001, 25000000}, options = {"Perfect Atom", "SSJB Wukong"}},
    {range = {25000001, 100000000}, options = {"SSJB Wukong", "Broccoli"}},
...
local questDataInsideID = {
    ...
    {range = {3000000000, math.huge}, options = {"Winter Beerus", "Vekuta (SSJBUI)"}}
}
